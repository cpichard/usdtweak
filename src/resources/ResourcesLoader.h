...
class ResourcesLoader {
  public:
    ...
    static bool RequestNewFontRegular(const std::string &fontPath) { _fontRegularPathRequested = fontPath; }
    static bool RequesNewFontMono(const std::string &fontPath) { _fontMonoPathRequested = fontPath; }
    static bool SetGlyphRangeName(const std::string &glyphName) { _glyphRange = glyphName; }
