...
ToolDefs BuildReadOnlyToolDefinitions() {
    ...
    // 7b. run_query — UTQL, the expressive complement to find_prims.
    {
        ...
        props["query"] = MakeStringParam(
            ...
            "VALUE.IS_NONE• VALUE.IS_ASSET_MISSING• VARIABILITY INTERPOLATION "
            ...
            "VALUE.SCALAR > 1000\n"
            "  FIND USDATTRIBUTE WHERE VALUE.IS_ASSET_MISSING\n"
        ...
        tools.push_back(JsValue(_Tool(
            ...
            "animation (HAS_TIME_SAMPLES), missing assets (VALUE.IS_ASSET_MISSING), "
