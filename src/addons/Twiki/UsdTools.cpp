...
ToolDefs BuildReadOnlyToolDefinitions() {
    ...
    // 7b. run_query — UTQL, the expressive complement to find_prims.
    {
        ...
        props["query"] = MakeStringParam(
            ...
            "arc.\n"
            "PRIM fields: NAME PATH TYPE(\"Mesh\") KIND(\"component\") "
            ...
            "NAMESPACE(\"primvars\") VALUE.SCALAR (resolved value; "
            ...
            "time samples) VALUE.IS_NONE• VARIABILITY INTERPOLATION "
            ...
            "(• = unary bool flag.)\n"
            "RELATIONSHIP fields: NAME NAMESPACE "
...
ToolDefs BuildEditToolDefinitions() {
    ...
    // 19. run_mutation — UTQL write statements, the write complement to run_query.
    {
        ...
        props["statement"] = MakeStringParam(
            ...
            "Everything else is read-only; rename/reparent (SET NAME/PATH) is "
            "not supported.\n"
