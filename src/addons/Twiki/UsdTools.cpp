...
ToolDefs BuildReadOnlyToolDefinitions() {
    ...
    // 7b. run_query — UTQL, the expressive complement to find_prims.
    {
        ...
        props["query"] = MakeStringParam(
            ...
            "ATTRIBUTE fields: NAME TYPE_NAME "
            ...
            "`SDFPRIM WHERE SPECIFIER = \"over\"` finds override opinions. SDF* "
            ...
            "HAS_SUBLAYER• SUBLAYER.COUNT SUBLAYERS(set of sublayer asset paths: "
            "SUBLAYERS LIKE \"layout.usda\" or CONTAINS \"./layout.usda\"). Use "
            "FIND LAYER for 'which layers sublayer X', stage settings (up-axis/fps/"
            ...
            "  FIND LAYER WHERE SUBLAYERS LIKE \"layout.usda\" RETURN "
